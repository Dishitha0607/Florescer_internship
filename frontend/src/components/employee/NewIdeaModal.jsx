export default function NewIdeaModal({ showForm, setShowForm, formData, setFormData, errors, handleSubmit }) {
  return (
    <>
      {showForm && (
        <div className="fixed inset-0 flex justify-center items-center bg-black/60 z-50">
          <div className="glass-strong w-[550px] rounded-3xl p-8 border border-border shadow-2xl animation-fade-in">
            ...
            />
            {errors.subject && <p className="text-red-400 text-sm mb-3">{errors.subject}</p>}
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-2xl p-4 mb-4 outline-none focus:border-primary"
            />
            {errors.empName && <p className="text-red-400 text-sm mb-3">{errors.empName}</p>}
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-2xl p-4 mb-4 outline-none focus:border-primary"
            />
            {errors.classification && <p className="text-red-400 text-sm mb-3">{errors.classification}</p>}
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-2xl p-4 mb-4 outline-none focus:border-primary"
            />
            {errors.targetDate && <p className="text-red-400 text-sm mb-3">{errors.targetDate}</p>}
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-2xl p-4 mb-4 outline-none focus:border-primary"
            />
            {errors.budget && <p className="text-red-400 text-sm mb-3">{errors.budget}</p>}
